  ...
  return (
    <div className="">
      ...
      <section className="mb-10">
        ...
        <div className="mt-4 space-y-4 text-gray-300 leading-7">
          <p>
            PrideAtlas.io is a project in progress, and I'm always looking for ways to improve it. If you have any feedback, suggestions, or want to contribute, please email me at <a href="mailto:galdevops@gmail.com" className="text-blue-400 underline">galdevops@gmail.com</a>
          </p>
        </div>
      </section>
